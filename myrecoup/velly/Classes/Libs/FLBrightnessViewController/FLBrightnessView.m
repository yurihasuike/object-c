...
#define TOCROPVIEW_BACKGROUND_COLOR [UIColor colorWithWhite:0.0f alpha:1.0f]    // 0.12f
...
static const NSInteger kBackgroundImageViewTag          = 1978;
static const NSInteger kBackgroundImageViewContainerTag = 19782015;
static const NSInteger kScrollViewTag                   = 1978201501;
...
@interface FLBrightnessView () <UIScrollViewDelegate, UIGestureRecognizerDelegate>
...
@implementation FLBrightnessView
...
- (void)setup
{
    ...
    self.scrollView.tag = kScrollViewTag;
    ...
    self.backgroundImageView.tag = kBackgroundImageViewTag;
    ...
    self.backgroundContainerView.tag = kBackgroundImageViewContainerTag;
...
//    self.overlayView.hidden = YES;  // NO
...
//    self.foregroundContainerView.tag = kForegroundImageViewContainerTag;
...
//    //self.foregroundImageView = [[UIImageView alloc] initWithImage:nil];
//    self.foregroundImageView.tag = kForegroundImageViewTag;
...
- (void)brightnessImageNinetyDegreesAnimated:(BOOL)animated image:(UIImage *)image sliderVal:(CGFloat)sliderVal
{
    ...
    UIImageView *uiImageView = (UIImageView*)[self viewWithTag:kBackgroundImageViewTag];
    if(uiImageView){
