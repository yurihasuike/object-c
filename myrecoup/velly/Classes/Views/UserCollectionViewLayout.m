...
NSString* const UserLayoutCellKind      = @"UserCell";
NSString* const UserLayouDecorationKind = @"UserDecorationCell";

@interface UserCollectionViewLayout()
...
- (void)setup {
    [self registerClass:[ProfileDecorationCollectionReusableView class] forDecorationViewOfKind:UserLayouDecorationKind];
...
- (UICollectionViewLayoutAttributes *)layoutAttributesForItemAtIndexPath:(NSIndexPath *)indexPath {
    return self.layoutInfo[UserLayoutCellKind][indexPath];
}
...
(NSString*)decorationViewKind atIndexPath:(NSIndexPath *)indexPath {
    return self.layoutInfo[UserLayouDecorationKind][indexPath];
}
...
- (void) calculateItemsAttributes {
    ...
    [UICollectionViewLayoutAttributes layoutAttributesForDecorationViewOfKind:UserLayouDecorationKind
    ...
    newLayoutInfo[UserLayoutCellKind] = cellLayoutInfo;
    newLayoutInfo[UICollectionElementKindSectionHeader] = titleLayoutInfo;
    newLayoutInfo[UserLayouDecorationKind] = @{indexPath: emblemAttributes};
