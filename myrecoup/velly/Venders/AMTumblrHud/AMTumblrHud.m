...
- (void)configUI {
    ...
    //self.backgroundColor = UIColorFromRGB(0x34465C);

    UIView *rect1 = [self drawRectAtPosition:CGPointMake(0, 0)];
    UIView *rect2 = [self drawRectAtPosition:CGPointMake(10, 0)];
    UIView *rect3 = [self drawRectAtPosition:CGPointMake(20, 0)];
    
    UIImageView *image1View = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"ico_star.png"]];
    image1View.frame = rect1.frame;
    [rect1 addSubview:image1View];
    
    UIImageView *image2View = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"ico_star.png"]];
    image2View.frame = rect2.frame;
    [rect2 addSubview:image2View];

    UIImageView *image3View = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"ico_star.png"]];
    image3View.frame = rect3.frame;
    [rect3 addSubview:image3View];
    ...
    [UIView animateWithDuration:duration
     ...
     //options:UIViewAnimationOptionCurveEaseOut
                     animations:^{
                         ...
                         rect.frame = CGRectMake(rect.frame.origin.x,
                                                rect.frame.origin.y - 10,
...
- (UIView *)drawRectAtPosition:(CGPoint)positionPoint {
    ...
    rectFrame.size.width = 14;
    rectFrame.size.height = 14;
