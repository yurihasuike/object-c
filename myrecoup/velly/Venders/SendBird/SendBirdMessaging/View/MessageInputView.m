...
- (void) initView
{
    ...
    self.openChannelListButton.hidden = YES;
    ...
    [self.messageTextField setPlaceholder:NSLocalizedString(@"MessagePlaceHolder", nil)];
    [self.messageTextField setTextColor:UIColorFromRGB(0x37434f)];
    [self.messageTextField setAttributedPlaceholder:[[NSAttributedString alloc] initWithString:NSLocalizedString(@"MessagePlaceHolder", nil) attributes:@{NSForegroundColorAttributeName: UIColorFromRGB(0xbbc3c9)}]];
    ...
    [self.fileAttachButton setImage:[UIImage imageNamed:@"camera-icon.png"] forState:UIControlStateNormal];
    [self.fileAttachButton setImage:[UIImage imageNamed:@"camera-icon.png"] forState:UIControlStateHighlighted];
    [self.fileAttachButton setImage:[UIImage imageNamed:@"camera-icon.png"] forState:UIControlStateSelected];
