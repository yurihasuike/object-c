...
- (void) initViews
{
   ...
   // [self.messageBackgroundImageView setImage:[UIImage imageNamed:@"_bg_chat_bubble_purple"]];
    [self.messageBackgroundImageView setBackgroundColor:HEADER_UNDER_BG_COLOR];
    ...
    [self.unreadLabel setTextColor:HEADER_UNDER_BG_COLOR];
    [self.unreadLabel setFont:[UIFont systemFontOfSize:kMyMessageUnreadFontSize]];
    [self.unreadLabel setText:NSLocalizedString(@"Unread", nil)];
