...
- (void) initViews
{
    ...
    self.messageBackgroundImageView.layer.borderWidth = 0.7f;
    self.messageBackgroundImageView.layer.borderColor = [UIColorFromRGB(0xacaab2) CGColor];
    self.messageBackgroundImageView.layer.cornerRadius = 10;
    self.messageBackgroundImageView.clipsToBounds = true;
    ...
    [self.nicknameLabel setTextColor:UIColorFromRGB(0xacaab2)];
    ...
    [self addConstraint:[NSLayoutConstraint constraintWithItem:self.nicknameLabel
                                                     ...
                                                     relatedBy:NSLayoutRelationEqual
                                                        toItem:self
                                                     attribute:NSLayoutAttributeLeading
                                                    multiplier:1 constant:kFileLinkBalloonLeftPadding+5]];
    [self addConstraint:[NSLayoutConstraint constraintWithItem:self.nicknameLabel
                                                     attribute:NSLayoutAttributeWidth
    ...
    [self addConstraint:[NSLayoutConstraint constraintWithItem:self.messageBackgroundImageView
                                                     ...
                                                     relatedBy:NSLayoutRelationEqual
                                                        toItem:self
                                                     attribute:NSLayoutAttributeLeading
                                                    multiplier:1 constant:kFileLinkBalloonLeftPadding - 2]];
    [self addConstraint:[NSLayoutConstraint constraintWithItem:self.messageBackgroundImageView
